  ...
  {post?.media?.length > 0 ? (
    ...
    <p className="text-center py-4">No media available</p>
          ...
          <img
            ...
            alt="Dairy Spiral"
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-16 h-full hidden lg:block"
          />
          ...
          <div className="w-full lg:w-1/2  h-full">
            ...
            <div className="p-4 -mb-3">
              <h2 className="text-[20px] font-semibold pl-6">{post.mainLocation}</h2>
              <p className="text-gray-700 text-sm lg:text-[12px] pl-6">
                {post.caption}
              </p>
            </div>
            <div className="flex p-2 space-x-2 lg:pl-9 mb-2">
              <button
                className={`rounded-lg bg-gray-200 border-2 border-gray-400 text-gray-600 text-[12px] items-center  px-2 py-1 flex ${
              ...
              >
                <img src={experience} className="m-1 w-5" alt="" />
                Experience
              </button>
              <button
                className={`rounded-lg bg-gray-200 border-2 border-gray-400 text-gray-600 px-2 py-1 text-[12px] items-center flex ${
                  selectedButton === "Cost"
                    ? "bg-white border border-gray-400"
                    : ""
                }`}
              ...
              >
                <img src={cost} className="m-1 w-5" alt="" />
                Cost
              </button>
              <button
                className={`rounded-lg bg-gray-200 border-2 border-gray-400 text-gray-600 px-2 py-1 text-[12px] items-center flex ${
              ...
              >
                <img src={location} className="m-1 w-5" alt="" />
                Places
              </button>
              <button
                className={`rounded-lg bg-gray-200 border-2 border-gray-400 text-gray-600 px-2 py-1 text-[12px] items-center flex ${
              ...
              >
                <img src={message} className="m-1 w-5" alt="" />
                Messages
              </button>
              <button
                className={`rounded-lg bg-gray-200 border-2 border-gray-400 text-gray-600 px-2 py-1 flex ${
                  selectedButton === "More"
                    ? "bg-white border border-gray-400"
                    : ""
                }`}
            ...
            <div className="rounded-xl border-2 border-gray-300 mx-2 ml-9 shadow-md">
              {/* Other Post Details (Experience, Cost, Place, Message etc.) */}
              <div className="flex items-center text-gray-600 p-4 text-[14px]">
                <svg
            ...
            <div className="mx-2 ml-9 rounded-xl border-2 border-gray-300 shadow-md">
              <div className="flex flex-col items-center p-4">
                <div className="w-full h-2 bg-gray-200 rounded-lg relative">
                  <div
                    className="absolute bg-rating-gradient h-2 rounded-lg"
        ...
        ></div> */}
            ...
            <div className="rounded-b-lg rounded-xl border-2 border-gray-300 shadow-md mx-2 border-collapse ml-9 text-sm">
