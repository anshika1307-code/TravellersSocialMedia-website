  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 z-1000">
      <div className="relative bg-[#F2F0E3] p-5 px-5 rounded-2xl min-w-[30vw]">
        ...
        {step === 1 && (
          <>
            <h2 className="text-[32px] font-bold mb-5 -mt-2 text-left">
              Create Post
            </h2>
...
/> */}
              ...
              {selectedFile ? (
                ...
                <>
                  ...
                  />
                  <p className="text-center text-[13px] my-2">
                    Click to upload picture/video (Max 5 images)
                  </p>
                </>
              )}
              {files.length > 0 && (
        ...
        {step === 2 && (
          <div>
            <h2 className="text-[32px] font-bold mb-4">Experience Details</h2>
            <textarea
        ...
        {step === 4 && (
          <div>
            <h2 className="text-[32px] font-bold mb-4">Places Visited</h2>
        ...
        {step === 5 && (
          <div>
            <h2 className="text-[32px] font-bold mb-4">Food Items</h2>
        ...
        {step === 6 && (
          <div>
            <h2 className="text-[32px] font-bold mb-4">Hotels</h2>
            {formData.subLocations
            ...
            {formData.expenses.map((expense, index) => (
              <div key={index} className="flex items-center space-x-4 mb-4">
                ...
                <button
                  className="text-red-500 text-sm"
                  onClick={() => {
                    const updatedExpenses = formData.expenses.filter(
                      (_, i) => i !== index
                    );
