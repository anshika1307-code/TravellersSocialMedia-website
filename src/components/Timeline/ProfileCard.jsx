...
return (
  <div className="max-w-xs ml-2 mt-3">
    <div className="relative rounded-xl shadow-md border border-gray-600/15 top-11 ">
      {/* Avatar */}
      ...
      {/* Details */}
      <div className="px-6 py-4 pt-9 border-b border-gray-300 bg-white/60 rounded-xl">
        {/* Name */}
